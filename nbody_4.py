...
def advance(dt, cached_body_pairs):
    '''
...
def nbody(loops, reference, iterations):
    ...
    # Modify nested for-loop
    for _ in range(loops):
        report_energy(cached_body_pairs)
        for _ in range(iterations):
            advance(0.01, cached_body_pairs)
        print(report_energy(cached_body_pairs))
